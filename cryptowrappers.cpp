...
std::vector<uint8_t> encrypt(const uint8_t* data, size_t size, Key key, IV iv, bool nopad) {
...
std::vector<uint8_t> decrypt(const uint8_t* data, size_t size, Key key, IV iv, bool nopad) {
